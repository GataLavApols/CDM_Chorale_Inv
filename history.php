...
<body>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" action="update_history.php" method="POST">
                ...
                <div class="form-group">
                    <label for="editDateReturn">Date Return:</label>
                    <input type="date" id="editDateReturn" name="date_return">
                </div>
                ...
                <div class="submit-container" style="display: flex; justify-content: space-between;">
                    <button type="button" class="delete-btn" onclick="confirmDelete(document.getElementById('editId').value)">
    ...
    function openEditModal(id, data) {
        ...
        document.getElementById('editDateReturn').value = data.date_return;
